 ...
 * @author t.normand
 */
public class PannelInscription extends javax.swing.JDialog {
     ...
     */
    public PannelInscription() {
        initComponents();
    }

    public PannelInscription(com.karimandco.admin.PanneauAdministration fenAdmin) {
        initComponents();
    ...
    private void initComponents() {
        ...
        panneauFormInscription1.setBackground(new java.awt.Color(255, 255, 255));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PannelInscription.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PannelInscription().setVisible(true);
            }
        });
    }
