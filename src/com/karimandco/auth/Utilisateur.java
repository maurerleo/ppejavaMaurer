...
public class Utilisateur {
    ...
    public void chargerInformationsUtilisateur() {
        if (Utilisateur.identifiant != null) {
            ResultSet lesResultats = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_utilisateurs WHERE identifiant='" + Utilisateur.identifiant + "'");
    ...
    public Boolean updateInformationsUtilisateurBDD() {
        ...
        if (Utilisateur.identifiant != null) {
            ...
            Integer compteur = DaoSIO.getInstance().requeteAction("UPDATE ppe3_utilisateurs SET nom='" + this.getNom() + "', prenom='" + this.getPrenom() + "', num_telephone='" + this.getNumeroTelephone() + "', courriel='" + this.getCourriel() + "', date_de_naissance='" + data_split_ok + "', photo='" + this.getPhoto() + "' WHERE identifiant='" + Utilisateur.getIdentifiant() + "'");
