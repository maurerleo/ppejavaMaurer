...
public class PanneauFormConnexion extends javax.swing.JPanel {
    ...
    private void jButtonConnexionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonConnexionActionPerformed
        if (identifiantOK && mdpOK) {
            ...
            ResultSet lesResultats = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_utilisateurs WHERE identifiant='" + this.panneauIdentifiant.getChamp2().getText() + "' AND mot_de_passe='" + mdp_sha256 + "'");
            try {
