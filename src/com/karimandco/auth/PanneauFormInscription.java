...
public class PanneauFormInscription extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        panneauNom.setForeground(new java.awt.Color(1, 159, 241));

        panneauPrenom.setForeground(new java.awt.Color(1, 159, 241));

        panneauIdentifiant.setForeground(new java.awt.Color(1, 159, 241));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if (nomOK && prenomOK && identifiantOK && courrielOK && numeroTelephoneOK && dateNaissanceOK && mdpOK) {
            ...
            if (DaoSIO.getInstance().requeteAction("INSERT INTO ppe3_utilisateurs (nom, prenom, identifiant, courriel, num_telephone, date_de_naissance, mot_de_passe, photo) VALUES ('" + this.panneauNom.getChamp2().getText() + "', '" + this.panneauPrenom.getChamp2().getText() + "', '" + this.panneauIdentifiant.getChamp2().getText() + "', '" + this.panneauCourriel.getChamp2().getText() + "', '" + this.panneauNumeroTelephone.getChamp2().getText() + "', '" + date_newFormat + "', '" + mdp_sha256 + "', '')") > 0) {
