...
public class Pdf {
    ...
    public Pdf(String nom, String prenom, String numero, String lienPDF) {
       ...
       // idUtilisateur = 106;
        idUtilisateur = JPanelConnexionBanque.iputilisaters;
    ...
    public String getUtilisateur(Integer id,String cat) throws SQLException {
        if (DaoSIO.getInstance().connexionActive()) {
            ...
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_utilisateurs WHERE id = " + id);
    ...
    public String getIDCV(Integer id) throws SQLException {
        if (DaoSIO.getInstance().connexionActive()) {
            System.out.println(DaoSIO.getInstance().connexionActive());
            ResultSet idcv = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_cv WHERE id_utilisateur = " + id);
            if (idcv.next()) {
    ...
    public String getFormation(String cat) throws SQLException {
        if (DaoSIO.getInstance().connexionActive()) {
            System.out.println(DaoSIO.getInstance().connexionActive());
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_formation WHERE id_cv = " + getIDCV(idUtilisateur) );
    ...
    public String getExperience(String cat) throws SQLException {
        if (DaoSIO.getInstance().connexionActive()) {
            System.out.println(DaoSIO.getInstance().connexionActive());
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_experience_pro WHERE id_cv = " + getIDCV(idUtilisateur) );
