...
public class CreationDuCV extends javax.swing.JPanel {
   ...
   // private final List<Ami> TabCv = new ArrayList<Ami>();
    ...
    private void initComponents() {
        ...
        jButtonValidationCV.setBackground(new java.awt.Color(1, 159, 241));
        ...
        jButtonValideExperiencePro.setBackground(new java.awt.Color(1, 159, 241));
        ...
        jLabel6.setForeground(new java.awt.Color(1, 159, 241));
                    ...
                    if (!description.equals("")) {
                        ...
                        if (!nom_maitrise.equals("") && !nom_maitrise.equals("Titre de la maitrise")) {
                            ...
                            if (update) {
                                res = DaoSIO
                                        .getInstance()
                                        .requeteAction("UPDATE `ppe3_cv` SET `titre` = '" + titre + "', `description` = '" + description + "', `nom_maitrise` = '" + nom_maitrise + "',`maitrise` = '" + maitrise + "' WHERE id = " + cv.get(0).get("id"));
                                
                                idCV = (Integer) cv.get(0).get("id");
                            } else {
                                    res = DaoSIO
                                            .getInstance()
                                            .requeteAction("INSERT INTO `ppe3_cv` (`id`, `titre`, `description`, `signature`, `nom_maitrise`, `maitrise`, `id_utilisateur`) "
                                    ...
                                    idCV =  DaoSIO.getInstance().getLastID("ppe3_cv", "id");
...
//            this.setVisible(false);
    ...
    public List<Map<String, Object>> getCV(Integer id, Integer id_utilisateur) throws SQLException {
        if (id != null && DaoSIO.getInstance().connexionActive()) {
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_cv WHERE id = " + id + " AND id_utilisateur = " + id_utilisateur);
    ...
    public List<Map<String, Object>> getFormation(Integer id) throws SQLException {
        ...
        if (cv != null) {
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_formation WHERE id_cv = " + cv.get(0).get("id"));
    ...
    public List<Map<String, Object>> getExperiencePro(Integer id) throws SQLException {
        List<Map<String, Object>> cv = getCV(this.idCV, id);
        if (cv != null) {
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT * FROM ppe3_experience_pro WHERE id_cv = " + cv.get(0).get("id"));
