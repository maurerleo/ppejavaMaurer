...
public class PanneauAdministration extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jButtonSuppToutUtilisateurs.setBackground(new java.awt.Color(1, 159, 241));
        ...
        jButtonRafraichir.setBackground(new java.awt.Color(1, 159, 241));
        ...
        jLabel1.setForeground(new java.awt.Color(1, 159, 241));
        ...
        jButtonCreerUtilisateur.setBackground(new java.awt.Color(1, 159, 241));
        ...
        jButtonModifierUtilisateur.setBackground(new java.awt.Color(1, 159, 241));
        ...
        jButtonSuppUtilisateur.setBackground(new java.awt.Color(1, 159, 241));
        ...
        cConnexionAdmin.getPanneauFormConnexion1().getjButtonConnexion().addMouseListener(new MouseListener() {
            ...
            public void mouseClicked(MouseEvent e) {
                ...
                if (Utilisateur.getInstance().getEstConnecte() && Utilisateur.getInstance().getStatut().equals(1)) {
                    ...
                    int option = jop.showConfirmDialog(null, "Voulez-vous vraiment supprimer l'intégralité de la table 'ppe3_utilisateurs' ?", "Confirmation requise", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    ...
                    if (option == JOptionPane.OK_OPTION) {
                        ...
                        if (DaoSIO.getInstance().requeteAction("DELETE FROM ppe3_utilisateurs WHERE statut = 0") == 1 && Supp == true) {
...
//                        }
    ...
    private void jButtonModifierUtilisateurActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonModifierUtilisateurActionPerformed
        ...
        if (idTable < 0) {
            ...
            String[] resultat = requeteSelectAllUpdateAdmin("SELECT * FROM ppe3_utilisateurs WHERE id = '" + id_admin + "'");
...
//                p class test id hu
                        ...
                        if (Utilisateur.getInstance().getEstConnecte() && Utilisateur.getInstance().getStatut().equals(1)) {
                            ...
                            if (option == JOptionPane.OK_OPTION) {
                                ...
                                try {
                                    ...
                                    if (helpers.supprimeToutCV(id_admin) && (DaoSIO.getInstance().requeteAction("DELETE FROM ppe3_utilisateurs WHERE id='" + id_admin + "' AND statut = 0") == 1 && Supp == true)) {
                                        jLabelEtatVider.setForeground(Color.blue);
    ...
    public void updateJTableInfo() {
        ...
        String[][] resultat = requeteSelectAllAdmin("SELECT * FROM ppe3_utilisateurs");
        //Si le nom de lignes du tableau de la BDD est supérieur à 0 alors application des données de la BDD à notre tableau
    ...
    public String[][] requeteSelectAllAdmin(String sql) {
        ...
        try {
            int nbr_ligne = 0;
            ResultSet res = DaoSIO.getInstance().requeteSelection("SELECT COUNT(*) FROM ppe3_utilisateurs");
            while (res.next()) {
    ...
    public String[] requeteSelectAllUpdateAdmin(String sql) {
        ...
        try {
            ...
            if (lesTuples_bis.next()) {
                ResultSet lesTuples = DaoSIO.getInstance().requeteSelection("SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'ppe3_utilisateurs'");
